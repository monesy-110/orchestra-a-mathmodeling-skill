...
def default_state(workspace: Path, title: str = "Orchestra", competition: str = "cumcm", output_format: str = "pdf") -> dict[str, Any]:
    manifest = load_manifest()
...
def init_state(workspace: Path, title: str = "Orchestra", competition: str = "cumcm", output_format: str = "pdf", force: bool = False) -> dict[str, Any]:
